...
import 'package:service_dashboard_app/features/vendor/controller_management/presentation/controller/vendor_add_new_controller.dart';
import 'package:service_dashboard_app/features/vendor/controller_management/presentation/widget/app_checkbox_tile.dart';

class VendorAddNewControllerScreen extends StatelessWidget {
  const VendorAddNewControllerScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<VendorAddNewController>(
      init: VendorAddNewController(),
      builder: (controller) {
        return Scaffold(
