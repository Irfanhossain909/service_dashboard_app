...
class VendorControllerManagementScreen extends StatelessWidget {
  const VendorControllerManagementScreen({super.key});
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed(
                      AppRoutes.instance.vendorAddNewControllerScreen,
                    );
                  },
                  child: Container(
